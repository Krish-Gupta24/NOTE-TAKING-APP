...
const Home = () => {
  ...
  const getAllNotes = async () => {
    try {
      const res = await axios.get("https://note-taking-app-znsn.onrender.com/api/note/all", {
  ...
  const deleteNote = async (data) => {
    ...
    try {
      const res = await axios.delete(
        "https://note-taking-app-znsn.onrender.com/api/note/delete/" + noteId,
        { withCredentials: true }
      )
  ...
  const onSearchNote = async (query) => {
    try {
      const res = await axios.get("https://note-taking-app-znsn.onrender.com/api/note/search", {
        params: { query },
        withCredentials: true,
      })
  ...
  const updateIsPinned = async (noteData) => {
    ...
    try {
      const res = await axios.put(
        "https://note-taking-app-znsn.onrender.com/api/note/update-note-pinned/" + noteId,
